...
# cpuset_check.sh
#
# https://raw.githubusercontent.com/IBM/powerai/master/support/cpuset_fix/cpuset_check.sh
#
...
#
# For docker: diff /sys/fs/cgroup/cpuset/docker/cpuset.mems /sys/fs/cgroup/cpuset/cpuset.mems is different
# then stop docker, rmdir /sys/fs/cgroup/cpuset/docker, restart docker
#
###############################################################################
#!/bin/bash
